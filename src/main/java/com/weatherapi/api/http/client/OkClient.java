...
public class OkClient implements com.weatherapi.api.http.client.HttpClient {
    /**
     * Private variables to implement singleton pattern
     */
    private static final Object synRoot = new Object();
    private static com.weatherapi.api.http.client.HttpClient sharedInstance = null;
    ...
    */
     ...
     */
    public void executeAsStringAsync(final HttpRequest httpRequest, final com.weatherapi.api.http.client.APICallBack<HttpResponse> callBack) {
     ...
     * @param   callBack    Async callback for events
     */
    public void executeAsBinaryAsync(final HttpRequest httpRequest, final com.weatherapi.api.http.client.APICallBack<HttpResponse> callBack) {
        okhttp3.Request okHttpRequest = convertRequest(httpRequest);
        client.newCall(okHttpRequest).enqueue(new okhttp3.Callback() {
    ...
    protected static void publishResponse(okhttp3.Response okHttpResponse, HttpRequest httpRequest,
        ...
        try {
            ...
            com.weatherapi.api.http.client.HttpContext context = new HttpContext(httpRequest, httpResponse);
